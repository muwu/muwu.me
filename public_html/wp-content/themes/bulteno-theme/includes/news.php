				...
				<div class="wrapper">
					...
					<div class="content-holder">
						...
						<div class="main-content<?php OT_content_class(OT_page_id());?>">
							...
							<h2 class="main-title very-first"><?php news_page_title();?></h2>
							...
							<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
								...
								<?php if(!$video) { ?>
									...
									?>
								<div <?php post_class("article-block".$class2); ?> id="post-<?php the_ID(); ?>">
									<?php
										if($image['show'] == true) {
									?>
								...
								<?php $image = get_post_thumb($post->ID,650,500); ?>
									<div <?php post_class("article-video-block"); ?> id="post-<?php the_ID(); ?>">
