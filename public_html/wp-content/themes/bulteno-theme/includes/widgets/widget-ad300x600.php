<?php
/*
 * Plugin Name: Custom 300x600 Ad Unit
...
class tz_ad600_widget extends WP_Widget {
	...
	function TZ_Ad600_Widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'tz_ad600_widget', 'description' => __('A widget that allows the display and configuration of of a single 300x600 Banner.', 'framework') );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 600, 'id_base' => 'tz_ad600_widget' );

		/* Create the widget */
		$this->WP_Widget( 'tz_ad600_widget', __(THEME_FULL_NAME.' Custom 300x600 Ad', 'framework'), $widget_ops, $control_ops );
	}
...
<?php
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => '',
		'ad' => get_template_directory_uri()."/images/no-banner-300x600.jpg",
