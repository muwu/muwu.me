            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'subtitle'  => __('Pick a main color for the theme (default: #CBCBCB).', 'redux-framework-demo'),
                        'default'   => '#511C69',
                        'validate'  => 'color',
                        'output'    => array(
                            'color'            => '.site-footer'
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    array(
                        ...
                        'type'      => 'textarea',
                        'title'     => __('Google Analytics', 'redux-framework-demo'),
                        'subtitle'  => __('Quickly add some Google Analytics code to your theme by adding it to this block.', 'redux-framework-demo'),
                        'validate'  => 'js',
                    ),
                )
            );
