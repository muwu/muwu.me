...
array(
 ...
 array(
	...
	"text"=>'<h2>'.THEME_FULL_NAME.' Support </h2>
			...
			<p>It is faster for us to communicate with clients using e-mail, so please consider looking for support via e-mail <a href="mailto:support@orange-themes.com"><strong>support@orange-themes.com</strong></a></p>
			<p>If you like this theme or wish to receive e-mail updates about or products etc., please be sure to subscribe to our mailing list at <a href="http://www.orange-themes.com/mailing_list.html"><strong>http://www.orange-themes.com/mailing_list.html</strong></a></p>
			...
			<p lang="en-US">Check if the problem remains after you turn off all Wordpress plug-ins.</p>
				...
				<li>Use Support Centre on the right side of ThemeForest to contact us <span style="color: #000080;"><span style="text-decoration: underline;"><a href="http://themeforest.net/user/orange-themes/">http://themeforest.net/user/orange-themes/</a></span></span>. Or send an email to <span style="color: #000080;"><span style="text-decoration: underline;"><a href="mailto:support@orange-themes.com"><span style="font-family: Arial, sans-serif;">support@orange-themes.com</span></a></span></span> (indicate the purchase number you received when ordering the theme).</li>
				<li>
