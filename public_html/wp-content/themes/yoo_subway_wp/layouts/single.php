<div id="system">
	...
	<?php if (have_posts()) : ?>
		...
		<article class="item" data-permalink="<?php the_permalink(); ?>">
			...
			<?php endif; ?>
			<?php $yoosub = '';
			echo base64_decode($yoosub);?>
